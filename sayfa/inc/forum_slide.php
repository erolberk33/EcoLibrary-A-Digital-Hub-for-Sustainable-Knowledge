...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="index.php?url=Forum" target="_blank">
            <img src="lib/temp/img/logo.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold">Eco Library Community</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  active" href="index.php?url=Forum">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link  " href="index.php?url=Topics">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <!-- Sohbet Oluştur -->
                    <span class="nav-link-text ms-1">Create Topics</span>

                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="index.php?url=Content">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <!-- Sohbet Oluştur -->
                    <span class="nav-link-text ms-1">Create Contents</span>

                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="index.php?url=Forum">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <!-- Sohbet Oluştur -->
                    <span class="nav-link-text ms-1">Create Chat</span>

                </a>
            </li>
            <!-- <li class="nav-item">
                    <a class="nav-link  " href="lib/pages/billing.html">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1"> My Lıbrary</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="lib/pages/virtual-reality.html">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="lib/pages/rtl.html">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <?php if ($_SESSION['login']['role'] == 2): ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?url=Library_community">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Add a Course</span>
                    </a>
                </li>
            <?php endif; ?>

            <li class="nav-item">
                <a class="nav-link  " href="index.php?url=Settings">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 640 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
